  ...
  useEffect(() => {
    const fetchBestSellers = async () => {
      ...
      try {
        ...
        // Display only top 4 for a curation feel
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="max-w-2xl">
            <span className="text-[10px] md:text-xs font-ui tracking-[0.3em] uppercase text-neutral-400 mb-4 block">
              Curated Selection
            </span>
            ...
            <p className="font-body text-neutral-500 text-sm md:text-base leading-relaxed">
              Discover our most sought-after designs, meticulously crafted for the discerning modern wardrobe.
            </p>
          </div>
          <Link
            to="/shop"
          ...
          >
            <span className="border-b border-neutral-200 pb-1 group-hover:border-black transition-colors">Explore Collection</span>
            <motion.span
              animate={{ x: [0, 5, 0] }}
